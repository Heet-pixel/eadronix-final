 ...
 * -------------------------------
 * Fires when the HOD edits Start Time. Auto-fills End Time to Start + 60
 * minutes (the same default a standard Lecture slot uses in the Schedule
 * module's calcEndTime()) — so the two fields stay in sync by default
 * instead of drifting apart. Once the HOD manually edits End Time
